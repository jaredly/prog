...
function remove(what){main.removeChild(what);} /************ check this ************/
...
function dst(a,b,c,d){
    return Math.abs( Math.sqrt( (a-c)*(a-c)+(b-d)*(b-d) ) );
}
...
/*************************  commenting out this -- replace w/ "properties" dialog
...
function addEvent(obj,evt,fn,bc) {
	if (obj.addEventListener)
		obj.addEventListener(evt,fn,bc);
	else if (obj.attachEvent)
		obj.attachEvent('on'+evt,fn);
}
function removeEvent(obj,evt,fn,bc) {
	if (obj.removeEventListener)
		obj.removeEventListener(evt,fn,bc);
